...
const SITEMAP = [
  {
    title: "Company",
    links: [{ name:"Alpha_Learn", to:"/"}, { name:"NewsLetter", to:"/contact/#news"}, {name:"Contact Us", to:"/contact"}, { name:"FAQs", to:"/#faq"}],
  },
  {
    title: "About Us",
      ...
      <div className="mx-auto w-full max-w-7xl  px-12 ">
        ...
        <div className="flex w-full flex-col items-center justify-center border-t border-blue-gray-50 py-4 md:flex-row md:justify-between">
          ...
          <div className="flex gap-4 text-blue-gray-900 sm:justify-center">
            ...
            <Link to="https://www.instagram.com/pritiish.tomar/">
            ...
            <Link to="https://www.github.com/PRITISH-TOMAR">
            ...
            <svg className="h-5 w-5 hover:fill-white" fill="gray"viewBox="0 0 24 24" aria-hidden="true">
                <path
                  ...
                  <Link to="https://pz-alpha.netlify.app/">
