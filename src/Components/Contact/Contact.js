...
const Contact = () => {
  ...
  return (
    <>
      <section className="relative z-10 overflow-hidden bg-black text-white py-20 dark:bg-dark lg:py-[120px] lg:px-[8vw] flex items-center justify-center  mx-2" >
        <div className="container ">
          <div className="-mx-4 flex flex-wrap lg:justify-between ">
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
              <div className="relative rounded-lg bg-cyan-900  text-black p-8 shadow-lg dark:bg-dark-2 sm:p-12  ">
                <form className="flex flex-col justify-center" ref={form} onSubmit={sendEmail} >
                  ...
                  />
                     <textarea className="h-[100px] mb-6 rounded px-2 outline-none" 
                  required
                    row="6"
